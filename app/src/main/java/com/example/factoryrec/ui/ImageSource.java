...
/**
 * Helper class used to set the source and additional attributes from a variety of sources. Supports use of a bitmap,
 * asset, resource, external file or any other URI.
 * <p>
 * When you are using a preview image, you must set the dimensions of the full size image on the ImageSource object for
 * the full size image using the {@link #dimensions(int, int)} method.
 */
public final class ImageSource {
    ...
    /**
     * Provide a loaded and cached bitmap for display. This bitmap will not be recycled when it is no longer needed. Use
     * this method if you loaded the bitmap with an image loader such as Picasso or Volley.
     *
     * @param bitmap
     *         bitmap to be displayed.
     */
     ...
     * bitmap, and tiling cannot be disabled when displaying a region of the source image.
     *
     * @return this instance for chaining.
     */
    ...
    /**
     * Use a region of the source image. Region must be set independently for the full size image and the preview if you
     * are using one.
     *
     * @return this instance for chaining.
     */
     ...
     * and also a preview image. When displaying a bitmap object, or not using a preview, you do not need to declare the
     * image dimensions. Note if the declared dimensions are found to be incorrect, the view will reset.
     *
     * @return this instance for chaining.
     */
